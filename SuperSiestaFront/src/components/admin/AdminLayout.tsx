...
import { LayoutDashboard, Package, Users, FileText, Receipt, Wallet, LogOut, PenSquare, Image, Newspaper, MapPin, ShoppingCart, SlidersHorizontal, Layers, Truck, Settings, Bell, Info, Mail, Shield } from "lucide-react";
